...
namespace AccountDownloader
{
    ...
    public class DesignData
    {
        ...
        private static readonly List<GroupRecord> _groups = new() {
            new GroupRecord("G-Group", "Group FOUR", new DesignStorageRecord()),
            new GroupRecord("G-Group1", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group2", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group3", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group4", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group5", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group6", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group7", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group8", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group9", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group10", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group11", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group11", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group11", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group11", "Group2", new DesignStorageRecord()),
            new GroupRecord("G-Group11", "Group2", new DesignStorageRecord()),
